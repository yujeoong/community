	...
	<div id="ListHeader">자유게시판</div>
		<!--    검색 옵션    -->
			<select id="searchType" name="searchType">
				...
				id="search_post" onclick="search_post(page2)" src="./resources/board/search_icon.png">
		</div>
		...
		%>
		<button class="btn btn-outline-primary pull-right" onclick="location.href='writeForm_g?categoryId=4'" id="btnWrite">글쓰기</button>
		<%
			}
		%>
