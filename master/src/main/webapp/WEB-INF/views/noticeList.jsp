...
<body>
	...
	<div class="container">
		...
		<div id="List" class="pull-left">
			...
			<div class="inline-block-center">
				<select id="searchType" name="searchType">
					...
					id="search_post" onclick="search_post(page2)"
					src="./resources/board/search_icon.png">
			</div>
		</div>
		...
		<button class="btn btn-outline-primary pull-right"
			onclick="location.href='writeForm_g?categoryId=6'" id="btnWrite">글쓰기</button>
		<%
			}
		%>
